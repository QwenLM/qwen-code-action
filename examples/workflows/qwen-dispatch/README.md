...
This workflow acts as a central dispatcher for Qwen Code, routing requests to the appropriate workflow based on the triggering event and the command provided in the comment.

- [Qwen Dispatch Workflow](#qwen-dispatch-workflow)
  - [Triggers](#triggers)
...
- **[qwen-review.yml](../pr-review/qwen-review.yml):** This workflow reviews a pull request.
- **[qwen-triage.yml](../issue-triage/qwen-triage.yml):** This workflow triages an issue.
- **[qwen-invoke.yml](../qwen-assistant/qwen-invoke.yml):** This workflow is a general-purpose workflow that can be used to perform various tasks.
